...
int lstat$INODE64(const char *file_name, struct stat *st)
{
    int r;
...
int stat$INODE64(const char *file_name, struct stat *st)
{
    int r;
...
int fstat$INODE64(int fd, struct stat *st)
{
    int r;
...
FTSENT *fts_children$INODE64(FTS *ftsp, int options)
{
    FTSENT *first;
    FTSENT *r;
